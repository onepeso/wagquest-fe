...
const CategoryHubUI = () => {
  return (
    <>
        ...
        <div className="md:container md:mx-auto flex flex-col gap-3">
          ...
          <div>
            <p className=" md:full lg:w-1/2">
              ...
              voluptatibus rerum quas. Quisquam quod, voluptates, dolorum,
              quidem soluta quia nemo eaque quos voluptatibus rerum quas.
            </p>
          </div>
        </div>
      ...
      <section
        id="attractions"
        className="md:container md:mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mt-8 w-full max-w-8xl px-4 py-12"
      >
        <AttractionCard />
      </section>
    </>
